...
class IRNetBox:
    ...
    def irsend_raw(self, port, power, data):
        ...
        * `data` is a byte array as exported by the RedRat Signal DB Utility.
        ...
        """
        if self.ir_netbox_model == NetBoxTypes.MK2:
            self.reset()
            self.indicators_on()
            ...
            self.reset()
        elif self.ir_netbox_model == NetBoxTypes.MK3:
            ...
            self._send(
                ...
                struct.pack(
                    ...
                    data))
        elif self.ir_netbox_model == NetBoxTypes.MK1:
    ...
    def _send(self, message_type, message_data=""):
        ...
        if response_type == MessageTypes.DEVICE_VERSION:
            self.ir_netbox_model, = struct.unpack('H', response_data[10:12])
