...
test_record() {
    ...
    [ -f 0000-gamut-complete.png ] &&
    [ -f 0001-checkers-8-complete.png ] &&
    [ -f 0002-smpte-complete.png ] &&
    cp "$testdir/videotestsrc-gamut.png" 0000-gamut-complete.png &&
    cp "$testdir/videotestsrc-checkers-8.png" 0001-checkers-8-complete.png &&
    cp "$testdir/videotestsrc-redblue.png" 0002-smpte-complete.png &&
    stbt-run -v test.py
}
