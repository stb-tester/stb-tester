...
from package.a import *  # isort:skip pylint: disable=wildcard-import, import-error
...
def auto_selftest_GreetingFrameObject():
    r"""
    >>> GreetingFrameObject(frame=f("frame-object-with-dialog-different-background.png"))
    GreetingFrameObject(is_visible=True, greeting='hi!')
    >>> GreetingFrameObject(frame=f("frame-object-with-dialog.png"))
    GreetingFrameObject(is_visible=True, greeting='hi!')
    >>> GreetingFrameObject(frame=f("frame-object-with-dialog2.png"))
    GreetingFrameObject(is_visible=True, greeting='hi!')
    >>> GreetingFrameObject(frame=f("frame-object-without-dialog-different-background.png"))
    GreetingFrameObject(is_visible=True, greeting='hi!')
    >>> GreetingFrameObject(frame=f("frame-object-without-dialog.png"))
    GreetingFrameObject(is_visible=True, greeting='hi!')
    """
    pass
